document.addEventListener('DOMContentLoaded', async function() {
    ...
    function clearCurrentConversation() {
        ...
        if (conversation) {
            conversation.messages = conversation.messages.filter(m => m.sender === 'bot' && m.text.includes('你好！我是你的智能医学顾问'));
            chatMessages.innerHTML = '';

            // 保留欢迎消息
            const welcomeMessage = "你好！我是你的智能医学顾问。如果你有任何希望咨询的医疗问题，我都会提供帮助。";
    ...
    async function generateResponse(userMessage) {
        ...
        try {
            ...
            updateCurrentConversation(responseText, 'bot');
            return {
